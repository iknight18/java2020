...
public class SettingsController implements Initializable {
    ...
    //initialize the info in the grids with current user info
    @Override
    ...
    private void save(ActionEvent e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/PassValidation.fxml")); // load the password validation for more security
            ...
            //check constraints from setters
            ...
            if (v) {
                ...
                mail.setStyle("");
                try {
                    Authentification.UpdateInfo(p, Authentification.getCompteInfo(p)); // update in BD
